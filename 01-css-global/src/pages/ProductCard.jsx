  ...
  return (
    <div className="product-card" tabIndex={0}>
      ...
      <div className="product-image-wrapper">
        {product.tag && ( <span className={`product-tag ${product.tag.toLowerCase() === "novo" ? "novo" : "promo"}`}>{product.tag}</span>)}
      ...
      <button className="product-btn outline" role="button" disabled={product.outOfStock} aria-label={`Adicionar ${product.title} ao carrinho`}>
        Adicionar
      </button>
